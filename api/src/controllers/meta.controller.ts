...
class MetaController {
    ...
    public createMeta = async (req: Request, res: Response, next: NextFunction) => {
    ...
    public updateMeta = async (req: Request, res: Response, next: NextFunction) => {
    ...
    public deleteMeta = async (req: Request, res: Response, next: NextFunction) => {
        const metaId = req.params.metaId as string;
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) throw createValidationException(errors);
